...
### ulsteger: added two lines to get access to the needed files and functions
import sys
sys.path.insert(0,'/cluster/home/ulsteger/USIP')
...
### ulsteger: CHANGE to name of current dataset
object='brick'
### ulsteger: CHANGE to trained model, which should be used (1vN, FN)
model='FN'

dataset_type = 'modelnet'
### ulsteger: CHANGE to folder path to the pointclouds, for which keypoints should be generated
root = f'/cluster/home/ulsteger/3d_fracture_reassmbly/real_data/{object}'
### ulsteger: CHANGE to folder path of desired output folder for the keypoints
output_folder = f'/cluster/home/ulsteger/keypoints/{object}_{model}'
...
### ulsteger: load the trained model
if model == 'FN':
  detector_model_path = '/cluster/home/ulsteger/checkpoints/flipped_normals/gpu0_446_-0.661056_net_detector.pth'
elif model == '1vN':
  detector_model_path = '/cluster/home/ulsteger/checkpoints/connected_1vN/gpu0_448_-0.409977_net_detector.pth'
elif model == '1v1':
  detector_model_path = '/cluster/home/ulsteger/checkpoints/connected_1v1/gpu0_166_1.672287_net_detector.pth'
elif model == 'MN':
  detector_model_path = '/cluster/home/ulsteger/modelnet-pretrained/modelnet/5000-512-k1k32-3d/best.pth'
else:
  raise Exception('False training model')
# Modelnet: '/cluster/home/ulsteger/modelnet-pretrained/modelnet/5000-512-k1k32-3d/best.pth'
    ...
    for i, data in enumerate(testloader):
        ...
        for b in range(anc_pc.size(0)):
            ...
            if 'kitti' == dataset_type:
                ...
                ### ulsteger: added a second output file, to write a .npy file
                output_file1 = os.path.join(output_folder_new, '%d.npy' % anc_idx[b].item())
            else:
                assert False
