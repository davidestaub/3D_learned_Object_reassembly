...
class ChamferLoss_Brute(nn.Module):
    ...
    def forward(self, pc_src_input, pc_dst_input, sigma_src=None, sigma_dst=None):
        ...
        ### ulsteger: when training with the 1vN pairs, return 2.0*forward_loss, to only penalize far apart points on the single fragment.
        ### ulsteger: when training with the FN pairs, return forward_loss + backward_loss
