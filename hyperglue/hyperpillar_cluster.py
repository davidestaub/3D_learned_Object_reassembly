...
class Linear2D(nn.Module):
    def __init__(self):
        super().__init__()
        self.a1 = nn.Linear(10,10, bias=False)
        self.a2 = nn.Linear(10,10, bias=False)
        self.a3 = nn.Linear(100,32, bias=False)
    def forward(self,x):
        o1 = self.a1(x)
        o2 = self.a2(x).transpose(2,3)
        o1_v = o1.view(16,-1,100)
        o2_v = o2.view(16,-1,100)
        output = o1_v.bmm(o2_v)
        output = output.view(len(x),100) #??
...
class AttentionalGNN(nn.Module):
    def __init__(self, feature_dim: int, layer_names: List[str]) -> None:
        ...
        self.layers = nn.ModuleList([
            AttentionalPropagation(feature_dim, 8)
