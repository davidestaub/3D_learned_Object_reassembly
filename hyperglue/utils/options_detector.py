...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/cluster/home/ulsteger/training_data/', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/cluster/project/infk/courses/252-0579-00L/group19/3D_learned_Object_reassembly/hyperglue/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--input_pc_num', type=int, default=1000, help='# of input points')
        ...
        self.parser.add_argument('--keypoint_on_pc_alpha', type=float, default=5, help='weight of keypoint_on_pc loss, default 0.5.')
